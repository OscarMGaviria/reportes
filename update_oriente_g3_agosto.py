...
def update_corte(corredor_name, acts, obs, insumos=[]):
    ...
    # Buscar corte para 8/6/2026 (2026-08-06)
...
sa_acts = [
    {"nombre": "Topografía", "unidad": "km", "total": 19.22, "completado": 6.0},
    {"nombre": "Exploración Geotécnica", "unidad": "und", "total": 77, "completado": 41},
    {"nombre": "Limpieza de Obras Transversales", "unidad": "und", "total": 130, "completado": 105},
...
sa_insumos = [
    ...
    {"nombre": "Presentación diseño estructura (Hasta K1+850)", "responsable": "CONTRATISTA", "fecha_presentacion": "Agosto 11 del 2026", "estado_observacion": ""},
...
sa_obs = "Hasta el momento no se cuenta con diseños entregados por parte del Contratista. Se requiere que el contratista presente información de apiques y con ello avanzar en el diseño y fórmula de trabajo.\nNOTA TOPOGRAFÍA: Contratista hizo entrega de topografía k0+000 a k1+850 la cual es revisada por topogafía de interventoría. En esta propueta el constructor partió de suponer una velocidad de 30 km/h y pendiente transversal de 3 %. Se buscará definir modo de aprobación y/o liberación de esta propuesta de definición de rasante en el marco del mejoramiento en ejecución"
...
lq_sa_acts = [
    ...
    {"nombre": "Limpieza de Obras Transversales", "unidad": "und", "total": 100, "completado": 0},
...
print("Datos de ORIENTE GRUPO 3 AGOSTO actualizados exitosamente.")
